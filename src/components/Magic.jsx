...
Command: npx gltfjsx@6.1.4 public/models/magic/magic.glb
...
export function Magic(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("./models/magic/magic.glb");
...
useGLTF.preload("./models/magic/magic.glb");
